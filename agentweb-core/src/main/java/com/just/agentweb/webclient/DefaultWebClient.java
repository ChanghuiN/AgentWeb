...
public class DefaultWebClient extends WebViewClientDelegate {
    ...
    public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
        ...
        if (super.shouldOverrideUrlLoading(view, request) || shouldOverrideUrlLoading(view, url)) {
            return true;
        }
    ...
    public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
        ...
        if (request.isForMainFrame()) {
            onMainFrameError(view, error.getErrorCode(), error.getDescription().toString(),
